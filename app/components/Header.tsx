...
// ロゴ画像を使う場合: /public/logo.png を配置してください
const LOGO_IMAGE = "/logo.png";
const USE_LOGO_IMAGE = false; // ロゴ画像配置後に true に切り替え

export default function Header() {
  return (
    <header
      className="sticky top-0 z-50 border-b border-neutral-200/70 bg-white/80 backdrop-blur-md"
    ...
    >
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-5">
          <nav className="flex items-center gap-5 text-[13px] tracking-wide text-neutral-500">
